...
from .views import TokenGenarateView,BkashPaymentCreateView,BkassCallBackView,CreateVolentierViwe,StartDonationIntakeView,StopDonationIntakeView,DonationSeasonListView

urlpatterns = [
    path("start_donation_intake/",StartDonationIntakeView.as_view(),name="Start taking volentiers"),
    path("stop_donation_intake/",StopDonationIntakeView.as_view(),name="Stop taking volentiers"),
